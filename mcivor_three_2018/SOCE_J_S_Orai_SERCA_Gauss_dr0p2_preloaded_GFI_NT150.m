...
%% load SERCA fluxes
  tic   
    ...
    flux_SERCA_junction_all(:,:,ii)=volume_integral_junction(vol_int_J_z_NT150,vol_int_J_rt_NT150,0,Boundary_solution_junction_z_L2_rt_z')*vol_cyt_nm/vol_cyt_L/Dm;
    ...
    flux_SERCA_subPMER_all(:,:,ii)=volume_integral_S_flux_BC(vol_int_S_z_NT150,vol_int_S_rt_NT150,0,Boundary_solution_subPMER_z_L2_rt_z',z_s,r_s,theta)*vol_ER_nm/vol_ER_L/De;
...
%% Moving time forwards
    ...
    for i=(p-1)*n_timesteps+1:p*n_timesteps
        ...
        J_int=volume_integral_junction(vol_int_J_z_NT150,vol_int_J_rt_NT150,Micro_conc_IC,J_ra);
        J=J_int+J_CRAC_flux_int+flux_SERCA_junction;
                
        ER_PM_junction_soln(:,:,q(i))=J';
        
        S_int=volume_integral_S(vol_int_S_z_NT150,vol_int_S_rt_NT150,Sub_conc_IC,S_zL1,r_s,theta,z_s);
    ...
    if p==1
    save(fn_data,'ER_PM_junction_soln','Sub_PM_ER_soln')
    p
    elseif p==10
    save(fn_data,'ER_PM_junction_soln','Sub_PM_ER_soln')
    p
